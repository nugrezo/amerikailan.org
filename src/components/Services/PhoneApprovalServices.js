...
import "./PhoneApprovalServices.css";
...
const PhoneApprovalServices = () => {
  ...
  const handleTextCodeFormSubmit = (e) => {
    ...
    if (enteredCode === originalCode) {
      ...
      handleNext();
      navigate("/advertisement/services/services_details_s3");
    } else {
  ...
  return (
    <div className="adv-services_step_two">
      ...
      <ProgressBar />
      <div className="adv-services_step_two_main">
        <h3 id="services_cellphoneapr">2-Cep Telefon Numarasi Onayi</h3>
              ...
              >
                <ul>
                  ...
                  <li>
                    <button
                      type="submit"
                      className="submit_cellphone_btn_services"
                    >
                      Devam ediniz
                    </button>
                  </li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      {isTimerZero ? (
                        <button
                          type="button"
                          className="approve_cellphone_btn_services"
...
export default PhoneApprovalServices;
