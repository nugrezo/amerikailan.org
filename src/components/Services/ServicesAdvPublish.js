...
const ServicesAdvPublish = () => {
  ...
  return (
    <div className="adv_real_estate_publish">
      ...
      <ProgressBar />
      <div className="services_adv_publish_main">
        <h3 id="services_adv_publish_header">5-Ilani Yayinla</h3>
        <div className="services_adv_publish_form_main_wrapper">
          <h4>Yayinlanacak ilana ait bilgiler</h4>
          <div>
            <div className="services_adv_publish_form_result_wrapper">
              <div className="services_adv_publish_main_wrapper">
                <form
                  className="services_adv_publish_form"
                  onSubmit={handlePublishFormSubmit}
                >
                  <div className="services_adv_publish adv_user_name">
                    <label htmlFor="user_name">Isim</label>
                    <input type="text"></input>
                  </div>
                  <div className="services_adv_publish adv_user_lastname">
                    <label htmlFor="user_lastname">Soyisim</label>
                    <input type="text"></input>
                  </div>
                  <div className="services_adv_publish adv_user_email">
                    <label htmlFor="adv_email">E-mail</label>
                    <input type="email"></input>
                  </div>
                  <div className="services_adv_publish adv_user_address">
                    <label htmlFor="adv_address">Ilan Adresi</label>
                    <input type="text"></input>
                  </div>
                  <div className="services_adv_publish adv_user_tel">
                    <label htmlFor="adv_tel">Telefon No</label>
                    <input type="text"></input>
                  </div>
                  <div className="services_adv_publish adv_user_category">
                    <label htmlFor="adv_category">Ilan Kategorisi</label>
                    <input type="text"></input>
                  </div>
                  <div className="services_adv_publish adv_user_price">
                    <label htmlFor="adv_price">Ucret</label>
                    <input type="text"></input>
                  </div>
                  <div className="services_adv_publish adv_user_date">
                    <label htmlFor="adv_date">Ilan Tarihi</label>
                    <input type="text"></input>
                  </div>
                  <div className="services_adv_publish_btn">
                    <button
                      type="submit"
                      className="services_publish_btn"
              ...
              {publish && (
                <div className="services_adv_publish_result_main_wrapper">
                  ...
                  <div className="services_publish_result_btn_container">
                    <Link to="/">
                      <button className="services_publish_result_btn">
                        Tamam
                      </button>
                    </Link>
                  </div>
...
export default ServicesAdvPublish;
