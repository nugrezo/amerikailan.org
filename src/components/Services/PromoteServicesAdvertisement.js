...
import "./PromoteServicesAdvertisement.css";
import ProgressBar from "../ProgressBar/ProgressBar";
import { AppContext } from "../ContextProvider";

const PromoteServicesAdvertisement = () => {
  ...
  const handleNavigateNext = () => {
    ...
    if (populerSelectValue || vitrinSelectValue) {
      handleNext();
      navigate("/advertisement/services/secure_payment", {
        state: { amount: isNaN(amount) ? "" : amount },
      });
    } else {
      handleNext();
      navigate("/advertisement/services/publish_s5");
    }
  };

  return (
    <div className="adv-services_step_four">
      ...
      <ProgressBar />
      <div className="adv-services_step_four_main">
        <h2>Ilaninizi On Plana Cikartin</h2>
        <div className="adv-services_step_four_main_wrapper">
...
export default PromoteServicesAdvertisement;
